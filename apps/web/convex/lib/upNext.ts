 ...
 * Move (ADR 0010). Plain text — no dates, no done states — with queue
 * semantics: the Next Move is the front of the line, and emptying that slot
 * promotes the next move into it.
 *
