 ...
 * Four variants of the top bar, switchable via `?headerVariant=` on any
 * authenticated route. A is what ships today and is the control.
 */

export const HEADER_VARIANTS = ["A", "B", "C", "E"] as const;
 ...
 * be padded to match: B and C float over the top, E floats over top and bottom.
 */
