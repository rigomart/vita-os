...
/**
 * One dense line of Area condition: attention-bearing Areas keep a named,
 * condition-coloured pill; healthy Areas shrink to a glyph-only tally.
 */
export function AreaConditionStrip({ areas }: { areas: DashboardArea[] }) {
