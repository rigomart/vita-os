...
import { followUpDateLabel, startOfLocalDay } from "./dashboard-model";
...
/**
 * One row of Area condition, weighted by urgency: each attention-bearing Area
 * reads as «icon» Name — reason, healthy Areas trail as a quiet glyph cluster.
 * The reason is the loudest thing that Area's Threads can say — soonest
 * follow-up, else next move, else last activity.
 */
export function AreaStatusBar({
  areas,
  threads,
  currentDate,
  onNewThreadInArea,
