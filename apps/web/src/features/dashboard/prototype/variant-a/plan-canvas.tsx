// PROTOTYPE — throwaway. Variant A copy of plan-canvas.tsx: identical to the
// production canvas except it renders the local LaneRow (linked lane headers,
// always-on condition status). Unmodified siblings come from the shared plan
// folder.
import type {
  DragEndEvent,
  DragOverEvent,
