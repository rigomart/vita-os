// PROTOTYPE — throwaway. Copy of ../../plan/plan-canvas.tsx for Variant C:
// identical wiring, but renders the Variant C LaneRow (linked headers,
// always-on condition labels). Unmodified siblings import from the real plan
// folder so drag/mutation behaviour stays byte-for-byte the same.
import type {
  DragEndEvent,
  DragOverEvent,
  DragStartEvent,
...
/**
 * Plan — the Area × day canvas, promoted to the whole dashboard in Variant C.
 *
