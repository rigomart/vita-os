...
import type { Density, PlanItem } from "./model";

import { agoLabel, waitingLabel } from "./model";
 ...
 *
 * Click — or Enter/Space while focused — opens the Thread rail. Dragging is
 * pointer-only (see the sensor note in `index.tsx`), so the keyboard never has
 * to fight dnd-kit for the Enter key.
 */
