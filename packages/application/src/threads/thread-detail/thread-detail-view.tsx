...
import { ThreadDetailSkeleton } from "../components/thread-detail-skeleton";
import { ThreadHeaderSection } from "../components/thread-header-section";
import { ThreadLifecycleActionsSection } from "../components/thread-lifecycle-actions-section";
import { ThreadResolvedNote } from "../components/thread-resolved-note";
import { ThreadStateChip } from "../components/thread-state-chip";
